            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{ alignSelf: "center", padding: 5 }}>
                    <View style={styles.profileImage}>
                        <TouchableOpacity activeOpacity={0.5} style={styles.image} onPress={() => { Alert.alert('Hello World') }}>
                            <Image source={require("../../assets/blank.png")} style={styles.image} resizeMode="center"></Image>
                        </TouchableOpacity>
                    </View>
                ...
                {/* <View style={styles.infoContainer}>
                    <Text style={[styles.text, { fontWeight: "200", fontSize: 36 }]}>League Auctions</Text>
                </View> */}
